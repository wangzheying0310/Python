...
if __name__ == '__main__':
                ...
                'updateRows': [
                    {
                        ...
                        'row': {
                            'inventorySource': 'KT',
                            'purchaseOrderSource': 'KT',
                            'purchaseRequestSource': 'KT',
                            'deliverySource': 'KT',
                        },
                    },
                ],
    ...
    if Invent_response['count'] != 0 and purchaseOrder_response['count'] != 0 and purchaseRequest_response['count'] != 0 and deliver_response['count'] != 0:
        print("获取到知识表数据，测试通过")
    else:
        print("测试未通过")
