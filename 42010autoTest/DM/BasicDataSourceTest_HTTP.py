...
if __name__ == '__main__':
                ...
                'updateRows': [
                    {
                        'tid': '1975992',
                        'row': {
                            'materialDictionarySource': 'HTTP',
                            'bomSource': 'HTTP',
                            'unitConversionSource': 'HTTP',
                            'productionVersionSource': 'HTTP',
                        },
                    },
                ],
                'deleteIds': [],
    ...
    if BOM_response['count'] == 0 and MaterialDictionary_response['count'] == 0 and ProductionVersion_response['count'] == 0:
        print("知识表中无数据，测试通过")
    else:
        print("测试未通过")
