...
if __name__ == '__main__':
    ...
    response_synchronizeBasicDataForClient = req.visit("post", "http://172.16.9.2:42010/api/engine/4/scenes/13", json={
    ...
    response_synchronizeDigitalSupplyChainParameterForClient = \
        req.visit("post", "http://172.16.9.2:42010/api/engine/4/scenes/13", json={
    ...
    # 开启调用分析
    response_analyse_start = req.visit("post", 'http://172.16.9.2:42010/api/engine/call/4/13/analyse/start',
                                       headers=headers,
                                       verify=False)
    ...
    # 获取请求结果
    response_analyse_result = req.visit("get", 'http://172.16.9.2:42010/api/engine/call/4/13/analyse/result',
    ...
    try:
        with open(f"./analyse_result-{datetime.now().strftime('%Y,%m,%d %H-%M-%S')}-XingNeng1.csv", 'w', newline='',
                  encoding='utf-8') as f:
    ...
    # 结束分析
    response_analyse_end = requests.post('http://172.16.9.2:42010/api/engine/call/4/13/analyse/stop', headers=headers,
                                         verify=False)
    # 打印时长
    ...
    response_instanceCount = req.visit("get", 'http://172.16.9.2:42010/api/engine/4/scenes/13/instanceCount',
                                       headers=headers, verify=False)
